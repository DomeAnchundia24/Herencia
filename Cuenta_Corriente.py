...
class Cuenta_corriente (Cuenta_Bancaria):
    ...
    def __init__(self, numero_cuenta=None, propietario=None, saldo: float = 0, tiene_cheque: bool = False):
        self._tiene_cheque = tiene_cheque
        super().__init__(numero_cuenta=numero_cuenta, propietario=propietario, balance=saldo)
...
if __name__ == '__main__':
    Cuentas_corrientes = Cuenta_corriente('1234567890', 'Domenica', 250, True)
